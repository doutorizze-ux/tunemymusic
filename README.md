...
**Transfer your music playlists between YouTube Music and Spotify with ease**

StaySoft is a modern, premium web application that allows users to seamlessly transfer their music playlists between YouTube Music and Spotify. With a beautiful purple/blue gradient design and intuitive interface, managing your music across platforms has never been easier.

![StaySoft Application](docs/screenshots/login-page.png)
