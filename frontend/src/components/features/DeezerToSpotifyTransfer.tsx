...
import { DeezerPlaylistSelector } from './DeezerPlaylistSelector'
...
export function DeezerToSpotifyTransfer() {
    ...
    const startTransfer = async () => {
        ...
        setIsStarting(true)
        try {
            const res = await fetch(`${API_BASE_URL}/deezer/transfer`, {
                method: 'POST',
            ...
            <div className="max-w-2xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-xl">
                ...
                <div className="mb-8">
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-4 overflow-hidden">
                        <div
                            className="bg-gradient-to-r from-purple-600 to-green-500 h-4 rounded-full transition-all duration-500 ease-out"
        ...
        <div className="space-y-8">
            <div className="text-center space-y-4">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white flex items-center justify-center gap-3">
                    <DeezerIcon className="w-8 h-8 text-purple-600" />
                    <ArrowRightIcon className="w-6 h-6 text-gray-400" />
                    <Music2 className="w-8 h-8 text-green-600" />
                </h2>
                <p className="text-gray-600 dark:text-gray-300 max-w-xl mx-auto">
                    Selecione uma playlist do Deezer para transferir para sua conta do Spotify.
                </p>
            </div>

            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 border border-gray-100 dark:border-gray-700">
                <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white flex items-center gap-2">
                    <span className="flex items-center justify-center w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-600 text-sm">1</span>
                    Selecione a Playlist de Origem
                </h3>

                <DeezerPlaylistSelector
            ...
            ${!selectedPlaylist
                            ...
                            : 'bg-gradient-to-r from-purple-600 to-green-600 hover:from-purple-700 hover:to-green-700 hover:scale-105 hover:shadow-2xl text-white'
                        }
          `}
                >
                    {isStarting ? (
